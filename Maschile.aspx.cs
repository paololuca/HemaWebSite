...
{
    public partial class Maschile : System.Web.UI.Page
    {
        ...
        {
            tournamentId = Convert.ToInt32(ConfigurationManager.AppSettings["Maschile"]);


            this.tournament = mHemaEngine.LoadTorunamentsDesc(tournamentId);
